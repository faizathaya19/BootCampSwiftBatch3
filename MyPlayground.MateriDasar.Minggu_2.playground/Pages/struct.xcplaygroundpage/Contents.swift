...
struct Employee {
    ...
    init(name: String, age: Int, jobTitle: String, employmentStatus: EmploymentStatus) {
        self.name = name
        self.age = age
...
let employee1 = Employee(name: "Faiz Athaya Ramadhan", age: 30, jobTitle: "iOS Dev", employmentStatus: .fullTime)
let employee2 = Employee(name: "Dono", age: 25, jobTitle: "Graphic Designer", employmentStatus: .partTime)
